    ...
    <>
      <div className="bg-[#FFA518] relative rounded-lg text-white flex items-center gap-3 justify-between px-3">
        <div className="flex-1">
          ...
          <p className="text-lg font-bold md:text-3xl">Clube Quack</p>
        ...
        <div className="flex-1 gap-1 flex flex-col items-center justify-center">
          <strong className="text-xl text-center font-bold md:text-3xl">
            R$ 299,99
          </strong>
          <button className=" rounded-lg py-1 px-2 text-[10px] md:text-xl bg-[#FF6D1D]">
